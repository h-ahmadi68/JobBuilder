...
import org.example.job_builder.flink.model.UserUnopenedLinkCount;
import org.example.job_builder.flink.utils.PaymentEventSourceFactory;
import org.example.job_builder.flink.utils.redis_sink.UserUnopenedCountRedisSink;
...
@Slf4j
@SuperBuilder
public class UserUnopenedLinkCountJob extends AbstractJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UserUnopenedLinkCountJobBuilder<?, ?> builder = UserUnopenedLinkCountJob.builder()
