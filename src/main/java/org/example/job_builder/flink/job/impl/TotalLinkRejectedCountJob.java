...
import org.example.job_builder.flink.model.RejectedLinkState;
import org.example.job_builder.flink.utils.PaymentEventSourceFactory;
import org.example.job_builder.flink.utils.redis_sink.RejectedLinkRedisSink;

import java.time.Duration;

@Slf4j
@SuperBuilder
public class TotalLinkRejectedCountJob extends AbstractJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var builder = TotalLinkRejectedCountJob.builder();

        populateCommonFields(builder, params);

        TotalLinkRejectedCountJob job = builder.build();
